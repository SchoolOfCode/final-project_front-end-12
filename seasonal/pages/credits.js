      ...
      <main>
        <div className={styles.pagecontainer}>
          <div className={styles.textcontainer}>
            <div className={styles.credIntro}>
              Icons from{" "}
            ...
            <div className={styles.listColumn}>
              <ul>
                ...
                <li>
                  <a
                    href="https://www.flaticon.com/authors/angdiz"
                    title="AngDiz"
                  >
                    AngDiz
                  </a>
                ...
                <li>
                  <a
                    href="https://www.flaticon.com/authors/artlega-studio"
                    title="Artlèga Studio"
                  >
                    Artlèga Studio
                  </a>
                </li>
                ...
                <li>
                  <a
                    href="https://www.flaticon.com/authors/kosonicon"
                    title="kosonicon"
                  >
                    kosonicon
                  </a>
              ...
              <ul>
                <li>
                  <a
                    href="https://www.flaticon.com/authors/luvdat"
                    title="Luvdat"
                  >
                    Luvdat
                  </a>
                ...
                <li>
                  <a
                    href="https://www.flaticon.com/authors/popo2021"
                    title="popo2021"
                  >
                    popo2021
                  </a>
                ...
                <li>
                  <a
                    href="https://www.flaticon.com/authors/seaicon"
                    title="Sea.icon"
                  >
                    Sea.icon
                  </a>
                ...
                <li>
                  <a
                    href="https://www.flaticon.com/authors/shmai"
                    title="shmai"
                  >
                    shmai
                  </a>
